...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -339.61, y = -157.34, z = 44.59 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 20, b = 255 },
		Type  = 22,
	},

	--Garage = {
		--Pos   = { x = -334.86, y = -109.88, z = 39.01 },
		--Size  = { x = 1.5, y = 1.5, z = 1.0 },
		--Color = { r = 250, g = 0, b = 50 },
		--Type  = 20,
	--},

	--Craft = {
		--Pos   = { x = -342.81, y = -104.79, z = 39.01 },
		---Size  = { x = 1.5, y = 1.5, z = 1.0 },
		--Color = { r = 255, g = 0, b = 0 },
		--Type  = 20,
	--},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -364.87, y = -120.75, z = 38.7 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -387.09, y = -103.03, z = 37.71 },
